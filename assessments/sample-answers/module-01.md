---
layout: default
title: "Sample Answer — Module 01: AI Impact Reflection"
permalink: /assessments/sample-answers/module-01/
---
...
```mermaid
graph TD
    A[Software Engineering] --> B[Code Generation]
    A --> C[Code Review]
    A --> D[Testing]
    A --> E[Documentation]
    A --> F[Architecture]
    ...
    B --> B1[GitHub Copilot]
    B --> B2[Cursor / Replit AI]
    C --> C1[DeepCode / Snyk]
    C --> C2[CodeRabbit]
    D --> D1[AI test generation]
    D --> D2[Automated QA agents]
    E --> E1[Copilot docstrings]
    F --> F1[Human judgment - AI assists]

    style F fill:#fff8c5,stroke:#d4a72c
    style F1 fill:#fff8c5,stroke:#d4a72c
```
<p class="diagram-caption">AI tools in modern software engineering — yellow = still primarily human domain</p>
